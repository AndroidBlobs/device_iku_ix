PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.com.google.clientidbase=android-jimi \
    ro.com.google.gmsversion=8.1_201810.go \
    ro.config.alarm_alert=Alarm_Default.mp3 \
    ro.config.default_message0=Default_SMS_Ringtone.mp3 \
    ro.config.default_message1=Default_SMS_Ringtone.mp3 \
    ro.config.default_message=Default_SMS_Ringtone.mp3 \
    ro.config.low_ram=true \
    ro.config.message_sound0=Default_SMS_Ringtone.mp3 \
    ro.config.message_sound1=Default_SMS_Ringtone.mp3 \
    ro.config.message_sound=Default_SMS_Ringtone.mp3 \
    ro.config.notification_sound=Default_SMS_Ringtone.mp3 \
    ro.config.ringtone0=Techno.mp3 \
    ro.config.ringtone1=Techno.mp3 \
    ro.config.ringtone=Techno.mp3 \
    ...
    ro.sf.lcd_height=85 \
    ro.sf.lcd_width=48 \
    ro.sh.nv.config=fs280_band18_com_rtm7289_spm6569 \
    ro.sh.project.name=sp7731e_fs280_64x4_demo_mantis_0023423.sh \
